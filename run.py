...
if __name__ == "__main__":
    ...
    parser.add_argument("--T", type=int, default=1, help="Diffusion steps")
    parser.add_argument("--num_samples", type=int, default=1, help="Number of samples of each cluster to generate after training")
